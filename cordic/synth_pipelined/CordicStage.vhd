...
--    22 Feb 25     Chris M.   Adapted pipelined sim files for synthesis.
-------------------------------------------------------------------------------
library ieee;
use std.textio.all;
...
package CordicConstants is
  ...
  -- Constants for the B inputs of the Z adders. Note that the exponent must be
  -- a real type in Xilinx.
...
entity CordicStage is
  generic (
    ...
    -- Note that the positive type includes 0 in GHDL but not in Xilinx; use
    -- natural type.
    i        : natural range 0 to wordsize
  );
