...
--    21 Feb 25     Chris M.   Removed logging for synthesis.
-------------------------------------------------------------------------------
library ieee;
use std.textio.all;
...
package CordicConstants is
  ...
  constant Z_CONSTANTS_CIRCULAR    : array_2d := (
    ...
    RealToQ3_18(arctan(2.0**(0.0))),
    RealToQ3_18(arctan(2.0**(-1.0))),
    RealToQ3_18(arctan(2.0**(-2.0))),
    RealToQ3_18(arctan(2.0**(-3.0))),
    RealToQ3_18(arctan(2.0**(-4.0))),
    RealToQ3_18(arctan(2.0**(-5.0))),
    RealToQ3_18(arctan(2.0**(-6.0))),
    RealToQ3_18(arctan(2.0**(-7.0))),
    RealToQ3_18(arctan(2.0**(-8.0))),
    RealToQ3_18(arctan(2.0**(-9.0))),
    RealToQ3_18(arctan(2.0**(-10.0))),
    RealToQ3_18(arctan(2.0**(-11.0))),
    RealToQ3_18(arctan(2.0**(-12.0))),
    RealToQ3_18(arctan(2.0**(-13.0))),
    RealToQ3_18(arctan(2.0**(-14.0))),
    RealToQ3_18(arctan(2.0**(-15.0)))
  );
  ...
  constant Z_CONSTANTS_LINEAR      : array_2d := (
    ...
    RealToQ3_18(2.0**(-8.0)),
    RealToQ3_18(2.0**(-9.0)),
    RealToQ3_18(2.0**(-10.0)),
    RealToQ3_18(2.0**(-11.0)),
    RealToQ3_18(2.0**(-12.0)),
    RealToQ3_18(2.0**(-13.0)),
    RealToQ3_18(2.0**(-14.0)),
    RealToQ3_18(2.0**(-15.0))
 );
 ...
 -- we repeat iterations 4 and 13 so that the expression
  ...
  constant Z_CONSTANTS_HYPERBOLIC  : array_2d :=  (
    ...
    --     { i - 1   :   i > 13
    --
    RealToQ3_18(arctanh(2.0**(-1.0))),   -- a_1
    RealToQ3_18(arctanh(2.0**(-2.0))),   -- a_2
    RealToQ3_18(arctanh(2.0**(-3.0))),   -- a_3
    RealToQ3_18(arctanh(2.0**(-4.0))),   -- a_4
    RealToQ3_18(arctanh(2.0**(-4.0))),   -- a_5 (repeat)
    RealToQ3_18(arctanh(2.0**(-5.0))),   -- a_6
    RealToQ3_18(arctanh(2.0**(-6.0))),   -- a_7
    RealToQ3_18(arctanh(2.0**(-7.0))),   -- a_8
    RealToQ3_18(arctanh(2.0**(-8.0))),   -- a_9
    RealToQ3_18(arctanh(2.0**(-9.0))),   -- a_10
    RealToQ3_18(arctanh(2.0**(-10.0))),  -- a_11
    RealToQ3_18(arctanh(2.0**(-11.0))),  -- a_12
    RealToQ3_18(arctanh(2.0**(-12.0))),  -- a_13
    RealToQ3_18(arctanh(2.0**(-13.0))),  -- a_14 
    RealToQ3_18(arctanh(2.0**(-13.0))),  -- a_15 (repeat)
    RealToQ3_18(arctanh(2.0**(-14.0)))   -- a_16
  );

  -- Must constrain string type because ISE does not support all of VHDL-2008
  type ModeStringType is array(0 to 1) of string(1 to 9);
  constant MODE_STRINGS : ModeStringType := ( "Rotation ", "Vectoring" );

  type CordStringType is array(0 to 3) of string(1 to 10);
...
entity CordicStage is
  ...
  port(
    ...
    d          : in std_logic;
    i          : in natural range 0 to wordsize;
...
begin
  ...
  -- 
  --
  -- Note that prior to VHDL-2008, sra was only defined for bit vectors, not std_logic_vectors.
  X_BIn <= std_logic_vector( shift_right( signed(Yin), (i + 1) ) ) when  ((CordSystem = HYPERBOLIC) and (i < 4))  else
          ...
          -- std_logic_vector(to_bitvector(signed(YIn) sra (i + 1))) when ((CordSystem = HYPERBOLIC) and (i < 4))  else
  ...
  Y_BIn <= std_logic_vector( shift_right( signed(Xin), (i + 1) ) ) when  ((CordSystem = HYPERBOLIC) and (i < 4))  else
         ...
         -- std_logic_vector((signed(XIn) sra (i + 1))) when ((CordSystem = HYPERBOLIC) and (i < 4))  else
